...
if ($_POST['name']!="") $name = stripslashes(htmlspecialchars($_POST['name']));
if ($_POST['fio']!="") $name = stripslashes(htmlspecialchars($_POST['fio']));
if ($_POST['phone']!="") $phone = stripslashes(htmlspecialchars($_POST['phone']));
if ($_POST['tel']!="") $phone = stripslashes(htmlspecialchars($_POST['tel']));
$email_client = $_POST['email'];
$_SESSION['name']=$name;
$_SESSION['phone']=$phone;
$_SESSION['email']=$email_client;

if(empty($phone)) { echo('<meta http-equiv="refresh" content="2; url=//'.$host.'">');
