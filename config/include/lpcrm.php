 <!-- lp-crm -->
  <fieldset>
	 ...
	 <? } } ?>
	-->
	<label for="product_id_crm">ID товара: </label><input id="product_id_crm" type="text" name="product_id_crm" value="<?=  $product_id_crm ?>" placeholder="ID товара в Вашей LP_CRM-системе.">
