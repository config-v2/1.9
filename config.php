<?php
/* * * * * * * * * * * * * * * * * * * * * * * 
 * Configuration v.1.9.8. for LandingPage:   *
 *                   lands                   *
 *   Last edition by 10.05.2018, 02:24:12    *
 * * * * * * * * * * * * * * * * * * * * * * */
...
<tr><td><b>Реферер:</b></td><td><a href='{$_SESSION['referer']}' target='_blank'>{$_SESSION['referer']}</a></td></tr><tr><td colspan='2'><p align='center'><b>UTM-метки: </b></p>{$utm} </tr></tr><tr><td><b>Комментарий к заказу:  </b></td><td><p>{$comment}</p></td></tr></table>";
$seller = "Название предприятия";
$seller_adress = "Адрес";
 ...
 *  Powered by Igor Saytin a.k.a. GreyGler   *
